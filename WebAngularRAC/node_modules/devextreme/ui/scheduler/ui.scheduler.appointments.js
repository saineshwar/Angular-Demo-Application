...
var SchedulerAppointments = CollectionWidget.inherit({
    ...
    _repaintAppointments: function(appointments) {
        ...
        for (var i = 0; i < itemsLength; i++) {
            ...
            if (itemData && true === item.needRemove) {
                this._clearItem(itemData);
                appointments.splice(i, 1);
                i--;
                continue
            }
            if (itemData && false === item.needRepaint) {
                this._processRenderedAppointment(item)
            }
            if (itemData && (!commonUtils.isDefined(item.needRepaint) || true === item.needRepaint)) {
